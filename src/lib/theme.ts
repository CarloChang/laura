...
export const TEXT_FIELDS: TextField[] = [
  ...
  { key: "about-script", label: "About — script", desc: "Cursive heading of the “cómo empezar” section.", default: "cómo empezar" },
  { key: "about-kicker", label: "About — subtitle", desc: "Small line under the about script heading.", default: "todo lo que necesitas saber antes de pedir" },
...
export const ELEMENT_COLORS: ElementColor[] = [
  ...
  { key: "c-about-script", textKey: "about-script", fallback: "terracotta" },
  { key: "c-about-kicker", textKey: "about-kicker", fallback: "muted-foreground" },
...
export const ELEMENT_FONTS: ElementFont[] = [
  ...
  { key: "ef-about-script", textKey: "about-script", default: "caveat" },
  { key: "ef-about-kicker", textKey: "about-kicker", default: "inter" },
